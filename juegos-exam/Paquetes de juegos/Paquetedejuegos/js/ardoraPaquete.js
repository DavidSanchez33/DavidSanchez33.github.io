...
$("#botonPechar").keydown(function(e){if (e.which!=9){PechaVentana();}});$("#suggestPost").keydown(function(e){if (e.which!=9){$("#suggestPost").click();}})
   ...
   menuLateral='';
   menuActividades='<h1></h1><a href="javascript:irA(0)" title="Ordenar palabras">1 </a><a href="javascript:irA(1)" title="Ordenar parrafos">2 </a><a href="javascript:irA(2)" title="Colorear leyenda">3 </a>';
...
taboaContidos[0]=new act("Ordenar palabras","Ordenar palabras","","<object width='100%' height='420' type='text/html' data='Ordenar_frases/Ordenar_frases.htm'></object>",true,"",true,false,false);
taboaContidos[1]=new act("Ordenar parrafos","Ordenar parrafos","","<object width='100%' height='420' type='text/html' data='OrdenParrafos/OrdenParrafos.htm'></object>",true,"",true,false,false);
taboaContidos[2]=new act("Colorear leyenda","Colorear leyenda","","<object width='100%' height='420' type='text/html' data='Colorear_Leyenda/Colorear_Leyenda.htm'></object>",true,"",true,false,false);
